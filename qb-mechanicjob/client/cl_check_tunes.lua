...
RegisterNetEvent('qb-mechanicjob:client:Menu', function()
	...
	local CheckMenu = {
		...
		{ icon = "fas fa-circle-xmark", header = "", txt = string.gsub(Loc[Config.Lan]["common"].close, "❌ ", ""), params = { event = "qb-mechanicjob:client:Menu:Close" } } }
		...
		if VehicleNitrous[trim(GetVehicleNumberPlateText(vehicle))] then
			...
			CheckMenu[#CheckMenu + 1] = { icon = "nos", header = Loc[Config.Lan]["check"].label58, txt = text, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "nos" } } }
		end

		CheckMenu[#CheckMenu + 1] = { icon = "engine"..(GetVehicleMod(vehicle, 11)+1), isMenuHeader = modEngineHead, header = Loc[Config.Lan]["check"].label1, txt = modEngine, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "engine" } } }
		CheckMenu[#CheckMenu + 1] = { icon = "brakes"..(GetVehicleMod(vehicle, 12)+1), isMenuHeader = modBrakesHead, header = Loc[Config.Lan]["check"].label2, txt = modBrakes, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "brakes" } } }
		CheckMenu[#CheckMenu + 1] = { icon = "suspension"..(GetVehicleMod(vehicle, 15)+1), isMenuHeader = modSuspensionHead, header = Loc[Config.Lan]["check"].label3, txt = modSuspension, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "suspension" } } }
		CheckMenu[#CheckMenu + 1] = { icon = "transmission"..(GetVehicleMod(vehicle, 13)+1), isMenuHeader = modTransmissionHead, header = Loc[Config.Lan]["check"].label4, txt = modTransmission, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "transmission" } } }
		CheckMenu[#CheckMenu + 1] = { icon = armicon, isMenuHeader = modArmorHead, header = Loc[Config.Lan]["check"].label5, txt = modArmor, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "armour" } } }
		CheckMenu[#CheckMenu + 1] = { icon = turicon, isMenuHeader = modTurboHead, header = Loc[Config.Lan]["check"].label6, txt = modTurbo, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "turbo" } } }
		CheckMenu[#CheckMenu + 1] = { icon = headicon, isMenuHeader = modXenonHead, header = Loc[Config.Lan]["check"].label7, txt = modXenon..xenonColor, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "xenon" } } }
		if GetGameBuildNumber() >= 2372 then
			if GetDriftTyresEnabled(vehicle) == 1 then
				CheckMenu[#CheckMenu + 1] = { icon = drifticon, isMenuHeader = modDriftHead, header = Loc[Config.Lan]["check"].label8, txt = modDrift, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "drift" } } }
			end
		end
		if GetVehicleTyresCanBurst(vehicle) == false then
			CheckMenu[#CheckMenu + 1] = { icon = bprooficon, isMenuHeader = modBproofHead, header = Loc[Config.Lan]["check"].label9, txt = modBproof, params = { event = "qb-mechanicjob:client:Menu:Remove", args = { vehicle = vehicle, mod = "bproof" } } }
		end
		CheckMenu[#CheckMenu + 1] = { icon = "fas fa-toolbox", header = "", txt = Loc[Config.Lan]["check"].label10, params = { event = "qb-mechanicjob:client:Menu:List" } }

	exports['qb-menu']:openMenu(CheckMenu)
end)

RegisterNetEvent('qb-mechanicjob:client:Menu:List', function()
...
---BRAKES
RegisterNetEvent('qb-mechanicjob:client:Menu:Remove', function(data)
	...
	if data.mod == "brakes" then icon = "brakes"..(GetVehicleMod(data.vehicle, 12)+1)
		...
		event = "qb-mechanicjob:client:giveBrakes"
	elseif data.mod == "engine" then icon = "engine"..(GetVehicleMod(data.vehicle, 11)+1)
		...
		event = "qb-mechanicjob:client:giveEngine"
	elseif data.mod == "suspension" then icon = "suspension"..(GetVehicleMod(data.vehicle, 15)+1)
		...
		event = "qb-mechanicjob:client:giveSuspension"
	elseif data.mod == "transmission" then icon = "transmission"..(GetVehicleMod(data.vehicle, 13)+1)
		...
		event = "qb-mechanicjob:client:giveTransmission"
	elseif data.mod == "armour" then icon = "car_armor"
		...
		event = "qb-mechanicjob:client:giveArmor"
	elseif data.mod == "turbo" then icon = "turbo"
		...
		event = "qb-mechanicjob:client:giveTurbo"
	elseif data.mod == "xenon" then icon = "headlights"
		...
		event = "qb-mechanicjob:client:giveXenon"
	elseif data.mod == "drift" then	icon = "drifttires"
		...
		event = "qb-mechanicjob:client:giveDrift"
	elseif data.mod == "bproof" then icon = "bprooftires"
		...
		event = "qb-mechanicjob:client:giveBulletProof"
	elseif data.mod == "nos" then icon = "nos" setheader = Loc[Config.Lan]["check"].label57
		...
		event = "qb-mechanicjob:client:giveNOS"
	end
	local CheckMenu = {
		...
		{ icon = "fas fa-circle-xmark", header = "", txt = string.gsub(Loc[Config.Lan]["check"].label48, "❌ ", ""), params = { event = "qb-mechanicjob:client:Menu" } } }
	exports['qb-menu']:openMenu(CheckMenu)
end)

RegisterNetEvent("qb-mechanicjob:client:cuscheck", function()
	local ped = PlayerPedId()
	local coords = GetEntityCoords(ped)
	local vehicle
	if not nearPoint(coords) then return end
